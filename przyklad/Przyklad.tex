...
%% Specjalnoœæ : Matematyka obliczeniowa i komputerowa
%%   Nr albumu : 666999
...
%%
%% ( Niniejszy tekst zosta³ wykorzystany za zgod¹ autora, Marcina Woliñskiego.
...
\usepackage{hyperref}%
  \hypersetup{%
		...
		pdftitle={Implementacja blabalizatora ró¿nicowego z~wykorzystaniem teorii fetorów sigma-rho},%
		pdfkeywords={blabaliza ró¿nicowa,fetory sigma-rho,fooizm,blarbarucja,blaba,fetoryka,baleronik},%
...
\promotor{dr hab. Filigran Fifak}
\nralbumu{666999}
\slowakluczowe{blabaliza ró¿nicowa, fetory $\sigma$-$\rho$, fooizm,
...
%%
Blabalizator ró¿nicowy\footnote{%
	Niniejszy tekst zosta³ wykorzystany za zgod¹ autora, Marcina Woliñskiego. Oryginalna wersja znajduje siê pod adresem:\par
...
jest podstawowym narzêdziem blabalii
